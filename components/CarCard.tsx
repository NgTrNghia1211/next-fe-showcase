...
import { calculatingCarRent } from '@/utils';
...
const CarCard = ({ car } : CarProps) => {
    ...
    const carRent = calculatingCarRent(city_mpg, year);
            ...
            <div className='relative flex w-full mt-2'>
                ...
                <div className='car-card__btn-container'>
                    <CustomButton title={'View more'} containerStyles='w-full py-[16px] rounded-full bg-primary-blue'
                        textStyles={'text-white text-[14px] leading-[17px] font-semibold'} rightIcon="/right-arrow.svg"
